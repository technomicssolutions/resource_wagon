...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.photo'
        db.add_column(u'employer_companyprofile', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompanyProfile.photo'
        db.delete_column(u'employer_companyprofile', 'photo')
