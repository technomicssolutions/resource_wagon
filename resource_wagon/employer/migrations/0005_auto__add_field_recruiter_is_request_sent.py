...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recruiter.is_request_sent'
        db.add_column(u'employer_recruiter', 'is_request_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Recruiter.is_request_sent'
        db.delete_column(u'employer_recruiter', 'is_request_sent')
