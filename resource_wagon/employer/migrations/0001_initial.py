...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'employer_companyprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('industry_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('company_profile', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'employer', ['CompanyProfile'])

        # Adding model 'Recruiter'
        db.create_table(u'employer_recruiter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('is_request_sent', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('job_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'employer', ['Recruiter'])

    def backwards(self, orm):
        # Deleting model 'CompanyProfile'
        db.delete_table(u'employer_companyprofile')

        # Deleting model 'Recruiter'
        db.delete_table(u'employer_recruiter')
