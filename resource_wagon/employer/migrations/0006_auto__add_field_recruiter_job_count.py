...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recruiter.job_count'
        db.add_column(u'employer_recruiter', 'job_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Recruiter.job_count'
        db.delete_column(u'employer_recruiter', 'job_count')
