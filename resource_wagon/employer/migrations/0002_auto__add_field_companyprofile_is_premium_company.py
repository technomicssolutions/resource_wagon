...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.is_premium_company'
        db.add_column(u'employer_companyprofile', 'is_premium_company',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompanyProfile.is_premium_company'
        db.delete_column(u'employer_companyprofile', 'is_premium_company')
