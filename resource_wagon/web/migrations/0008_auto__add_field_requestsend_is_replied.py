...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestSend.is_replied'
        db.add_column(u'web_requestsend', 'is_replied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RequestSend.is_replied'
        db.delete_column(u'web_requestsend', 'is_replied')
