...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.search_count'
        db.add_column(u'web_job', 'search_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RequestSend.is_delete'
        db.add_column(u'web_requestsend', 'is_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Reply.is_delete'
        db.add_column(u'web_reply', 'is_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Job.search_count'
        db.delete_column(u'web_job', 'search_count')

        # Deleting field 'RequestSend.is_delete'
        db.delete_column(u'web_requestsend', 'is_delete')

        # Deleting field 'Reply.is_delete'
        db.delete_column(u'web_reply', 'is_delete')
