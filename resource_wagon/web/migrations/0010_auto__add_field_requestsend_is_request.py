...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestSend.is_request'
        db.add_column(u'web_requestsend', 'is_request',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RequestSend.is_request'
        db.delete_column(u'web_requestsend', 'is_request')
