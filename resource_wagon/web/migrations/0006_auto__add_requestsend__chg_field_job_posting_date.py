...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.posting_date'
        db.alter_column(u'web_job', 'posting_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
    def backwards(self, orm):
        ...
        # Changing field 'Job.posting_date'
        db.alter_column(u'web_job', 'posting_date', self.gf('django.db.models.fields.DateField')(null=True))
    models = {
        u'auth.group': {
