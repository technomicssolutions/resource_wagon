...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_job', (
            ...
            ('skills', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('industry', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('job_location', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('posting_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
            ...
            ('search_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('applicants_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['Job'])

        # Adding model 'RequestSend'
        db.create_table(u'web_requestsend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recruiter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.Recruiter'])),
            ('jobseeker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobseeker.Jobseeker'])),
            ('request_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
        ...
        db.send_create_signal(u'web', ['RequestSend'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RequestSend'
        db.delete_table(u'web_requestsend')
