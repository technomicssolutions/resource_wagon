...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Testmonials'
        db.create_table(u'web_testmonials', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('client_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['Testmonials'])

    def backwards(self, orm):
        # Deleting model 'Testmonials'
        db.delete_table(u'web_testmonials')
    ...
    models = {
        ...
        u'web.contactus': {
            ...
            'other': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'})
        },
        u'web.cvrequest': {
            'Meta': {'object_name': 'CVRequest'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'mobile': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        ...
        u'web.testmonials': {
            'Meta': {'object_name': 'Testmonials'},
            'client_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
