...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.applicants_count'
        db.add_column(u'web_job', 'applicants_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Job.applicants_count'
        db.delete_column(u'web_job', 'applicants_count')
