...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CVRequest'
        db.create_table(u'web_cvrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('mail', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('mobile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['CVRequest'])

    def backwards(self, orm):
        # Deleting model 'CVRequest'
        db.delete_table(u'web_cvrequest')
