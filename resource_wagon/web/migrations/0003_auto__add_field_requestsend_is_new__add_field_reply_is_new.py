...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestSend.is_new'
        db.add_column(u'web_requestsend', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Reply.is_new'
        db.add_column(u'web_reply', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RequestSend.is_new'
        db.delete_column(u'web_requestsend', 'is_new')

        # Deleting field 'Reply.is_new'
        db.delete_column(u'web_reply', 'is_new')
