...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestSend.request_date'
        db.add_column(u'web_requestsend', 'request_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RequestSend.request_date'
        db.delete_column(u'web_requestsend', 'request_date')
