...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_job', 'salary', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    def backwards(self, orm):

        # Changing field 'Job.salary'
        db.alter_column(u'web_job', 'salary', self.gf('django.db.models.fields.IntegerField')(null=True))
    models = {
        u'auth.group': {
