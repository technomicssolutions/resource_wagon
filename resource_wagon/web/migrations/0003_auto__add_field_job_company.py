...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'web_job', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.CompanyProfile'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Job.company'
        db.delete_column(u'web_job', 'company_id')
