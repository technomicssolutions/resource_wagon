...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Education.basic_edu_specialization'
        db.add_column(u'jobseeker_education', 'basic_edu_specialization',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Education.masters_specialization'
        db.add_column(u'jobseeker_education', 'masters_specialization',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Education.basic_edu_specialization'
        db.delete_column(u'jobseeker_education', 'basic_edu_specialization')

        # Deleting field 'Education.masters_specialization'
        db.delete_column(u'jobseeker_education', 'masters_specialization')
