...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Doctorate.doctrate'
        db.delete_column(u'jobseeker_doctorate', 'doctrate')

        # Adding field 'Doctorate.doctrate_name'
        db.add_column(u'jobseeker_doctorate', 'doctrate_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Doctorate.doctrate'
        db.add_column(u'jobseeker_doctorate', 'doctrate',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Doctorate.doctrate_name'
        db.delete_column(u'jobseeker_doctorate', 'doctrate_name')
    ...
    models = {
        ...
        u'jobseeker.certificates': {
            'Meta': {'object_name': 'Certificates'},
            'certificate_name': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'jobseeker.doctorate': {
            'Meta': {'object_name': 'Doctorate'},
            'doctrate_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
