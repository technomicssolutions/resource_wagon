...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Education.certificate'
        db.delete_column(u'jobseeker_education', 'certificate')
    ...
    def backwards(self, orm):
        # Adding field 'Education.certificate'
        db.add_column(u'jobseeker_education', 'certificate',
    ...
    models = {
        ...
        u'jobseeker.education': {
            ...
            'certificate': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['jobseeker.Certificates']", 'null': 'True', 'blank': 'True'}),
