...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jobseeker.country_code'
        db.add_column(u'jobseeker_jobseeker', 'country_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Jobseeker.country_code'
        db.delete_column(u'jobseeker_jobseeker', 'country_code')
