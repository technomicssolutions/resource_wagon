...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Education.doctrate'
        db.delete_column(u'jobseeker_education', 'doctrate')

    def backwards(self, orm):
        # Adding field 'Education.doctrate'
        db.add_column(u'jobseeker_education', 'doctrate',
