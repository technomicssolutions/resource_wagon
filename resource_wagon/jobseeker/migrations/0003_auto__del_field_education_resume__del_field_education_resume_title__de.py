...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'jobseeker_education', 'resume')

        # Deleting field 'Education.resume_title'
        db.delete_column(u'jobseeker_education', 'resume_title')

        # Deleting field 'Education.is_resume_show'
        db.delete_column(u'jobseeker_education', 'is_resume_show')

        # Deleting field 'Education.resume_text'
        db.delete_column(u'jobseeker_education', 'resume_text')

        # Adding field 'Jobseeker.resume_title'
        db.add_column(u'jobseeker_jobseeker', 'resume_title',
                      self.gf('django.db.models.fields.CharField')(default='Resume', max_length=200),
                      keep_default=False)

        # Adding field 'Jobseeker.resume'
        db.add_column(u'jobseeker_jobseeker', 'resume',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Jobseeker.resume_text'
        db.add_column(u'jobseeker_jobseeker', 'resume_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Jobseeker.is_resume_show'
        db.add_column(u'jobseeker_jobseeker', 'is_resume_show',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Education.resume'
        db.add_column(u'jobseeker_education', 'resume',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Education.resume_title'
        raise RuntimeError("Cannot reverse this migration. 'Education.resume_title' and its values cannot be restored.")
        # Adding field 'Education.is_resume_show'
        db.add_column(u'jobseeker_education', 'is_resume_show',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Education.resume_text'
        db.add_column(u'jobseeker_education', 'resume_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Jobseeker.resume_title'
        db.delete_column(u'jobseeker_jobseeker', 'resume_title')

        # Deleting field 'Jobseeker.resume'
        db.delete_column(u'jobseeker_jobseeker', 'resume')

        # Deleting field 'Jobseeker.resume_text'
        db.delete_column(u'jobseeker_jobseeker', 'resume_text')

        # Deleting field 'Jobseeker.is_resume_show'
        db.delete_column(u'jobseeker_jobseeker', 'is_resume_show')
    ...
    models = {
        ...
        u'web.job': {
            ...
            'func_role': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True', 'blank': 'True'}),
            ...
            'salary': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
