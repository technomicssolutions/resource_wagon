...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employment.currency'
        db.add_column(u'jobseeker_employment', 'currency',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Employment.currency'
        db.delete_column(u'jobseeker_employment', 'currency')
