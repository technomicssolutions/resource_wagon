...
from jobseeker.views import JobseekerRegistration, SavePersonalDetails, SaveCurrentEmployerDetails, SaveEducationalDetails,SaveResumeDetails,SavePhotoDetails,JobSeekerView
